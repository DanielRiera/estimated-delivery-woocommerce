            ...
            <tr valign="top">
                ...
                <td>
                    ...
                    <select name="_edw_mode" style="height: 34px !important;">
                        <option value="1" <?php selected("1", get_post_meta($product_id, '_edw_mode', true)) ?>><?=__('Estimated','estimated-delivery-for-woocommerce');?></option>
                        <option value="2" <?php selected("2", get_post_meta($product_id, '_edw_mode', true)) ?>><?=__('Guaranteed','estimated-delivery-for-woocommerce');?></option>
                    </select>
                    </label>
                </td>
            </tr>
