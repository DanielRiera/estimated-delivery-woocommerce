...
$edw_pm_block_class_edw = apply_filters( 'wcfm_pm_block_class_edw', 'simple variable booking non-groupbuy' );
if( !apply_filters( 'wcfm_is_allow_edw', true ) || !apply_filters( 'wcfm_is_allow_pm_edw', true ) ) { 
    $edw_pm_block_class_edw = 'wcfm_block_hide';
}
$disabledDays = get_post_meta($product->get_id(),'_edw_disabled_days', true);
if($disabledDays == "") { $disabledDays = []; }
?>
<div class="page_collapsible products_manage_edw edw <?php echo $edw_pm_block_class_edw ?>" id="wcfm_products_manage_form_edw_head"><label
        class="wcfmfa fa-calendar"></label>
    <?= __('Estimated Delivery', 'estimated-delivery-for-woocommerce'); ?><span></span>
</div>
<div class="wcfm-container wcfm-edw <?php echo $edw_pm_block_class_edw ?>">
    <div id="wcfm_products_manage_form_edw_expander" class="wcfm-content">
    <input type="hidden" value="1" name="_edw_overwrite" /></label>
    <div class="row-padding">
        <table class="form-table" style="text-align:left">
            <tr valign="top" class="wcfm_edw_days_block">
            ...
            <tr valign="top" class="wcfm_edw_max_days_block">
            ...
            <tr valign="top" class="wcfm_edw_days_out_stock_block">
            ...
            <tr valign="top" class="wcfm_edw_max_days_out_stock_block">
            ...
            <tr valign="top" class="wcfm_edw_days_backorders_block">
            ...
            <tr valign="top" class="wcfm_edw_max_days_backorders_block">
            ...
            <tr valign="top" class="wcfm_edw_mode_block">
            ...
            <tr valign="top" class="wcfm_edw_disabled_days_block">
                ...
                <td>
                    <label>
                        <input type="checkbox" class="wcfm-checkbox simple variable" name="_edw_disabled_days[]" value="Mon" <?= (in_array('Mon', $disabledDays) == true) ? 'checked="checked"' : ''; ?> />
                        <?=__('Monday','estimated-delivery-for-woocommerce');?>
                    </label>
                    <br>
                    <label>
                        <input type="checkbox" class="wcfm-checkbox simple variable" name="_edw_disabled_days[]" value="Tue" <?= (in_array('Tue', $disabledDays) == true) ? 'checked="checked"' : ''; ?> />
                        <?=__('Tuesday','estimated-delivery-for-woocommerce');?>
                    </label>
                    <br>
                    <label>
                        <input type="checkbox" class="wcfm-checkbox simple variable" name="_edw_disabled_days[]" value="Wed" <?= (in_array('Wed', $disabledDays) == true) ? 'checked="checked"' : ''; ?> />
                        <?=__('Wednesday','estimated-delivery-for-woocommerce');?>
                    </label>
                    <br>
                    <label>
                        <input type="checkbox" class="wcfm-checkbox simple variable" name="_edw_disabled_days[]" value="Thu" <?= (in_array('Thu', $disabledDays) == true) ? 'checked="checked"' : ''; ?> />
                        <?=__('Thursday','estimated-delivery-for-woocommerce');?>
                    </label>
                    <br>
                    <label>
                        <input type="checkbox" class="wcfm-checkbox simple variable" name="_edw_disabled_days[]" value="Fri" <?= (in_array('Fri', $disabledDays) == true) ? 'checked="checked"' : ''; ?> />
                        <?=__('Friday','estimated-delivery-for-woocommerce');?>
                    </label>
                    <br>
                    <label>
                        <input type="checkbox" class="wcfm-checkbox simple variable" name="_edw_disabled_days[]" value="Sat" <?= (in_array('Sat', $disabledDays) == true) ? 'checked="checked"' : ''; ?> />
                        <?=__('Saturday','estimated-delivery-for-woocommerce');?>
                    </label>
                    <br>
                    <label>
                        <input type="checkbox" class="wcfm-checkbox simple variable" name="_edw_disabled_days[]" value="Sun" <?= (in_array('Sun', $disabledDays) == true) ? 'checked="checked"' : ''; ?> />
